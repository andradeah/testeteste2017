...
namespace AvanteSales.SyncManager.SQLLiteProvider.SQLLiteService
{
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name = "SQLLiteServiceSoap", Namespace = "http://tempuri.org/")]
    public partial class SQLLiteService : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        {
            this.Url = "http://localhost/Master.CompactFramework.Sync.SQLLiteServer/SQLLiteService.asmx";
        ...
        /// <remarks/>
        public System.IAsyncResult BeginVerificaVersaoDLL(string mensagem, string versaoCompativel, string versaoAplicativoAvanteSales, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("VerificaVersaoDLL", new object[] {
                        mensagem,
                        versaoCompativel,
                        versaoAplicativoAvanteSales}, callback, asyncState);
        }

        /// <remarks/>
        public bool EndVerificaVersaoDLL(System.IAsyncResult asyncResult, out string mensagem)
        {
