        ...
        private decimal? CalculaFormulaF029()
        {
            ...
            try
            {
                ...
                if (quantidadeUnidadeMedidaProduto > 0 && quantidadeUnidadeMedidaMinima > 0 && quantidadeUnidadeMedidaFree > 0)
                {
                    ...
                    quantUndMin = quantidadeInteira * (quantidadeUnidadeMedidaProduto / quantidadeUnidadeMedidaMinima);
                    quantUndFree = quantidadeInteira * (quantidadeUnidadeMedidaProduto / quantidadeUnidadeMedidaFree);

                    /// Quantidade Minima 
                    if (quantUndMin >= quantidadeMinima)
                    {
                        val = GetSumTmpPricingCons(NMCONDINI_ANT, NMCONDFIM_ANT) * -1;
                        quantidadeFree = (quantUndFree / quantidadeGratis) * quantidadeAdicional;
