...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AvanteSales.Pro.Fragments.ProdutoVenda, AvanteSales.Pro, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ProdutoVenda.class, __md_methods);
	}


	public ProdutoVenda () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ProdutoVenda.class)
			mono.android.TypeManager.Activate ("AvanteSales.Pro.Fragments.ProdutoVenda, AvanteSales.Pro, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
