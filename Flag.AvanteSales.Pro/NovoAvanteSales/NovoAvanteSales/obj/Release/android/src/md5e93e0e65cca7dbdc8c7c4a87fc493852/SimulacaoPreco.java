...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AvanteSales.Pro.Activities.SimulacaoPreco, AvanteSales.Pro, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", SimulacaoPreco.class, __md_methods);
	}


	public SimulacaoPreco () throws java.lang.Throwable
	{
		super ();
		if (getClass () == SimulacaoPreco.class)
			mono.android.TypeManager.Activate ("AvanteSales.Pro.Activities.SimulacaoPreco, AvanteSales.Pro, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
