...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AvanteSales.Pro.Activities.Sincronizacao, AvanteSales.Pro, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", Sincronizacao.class, __md_methods);
	}


	public Sincronizacao () throws java.lang.Throwable
	{
		super ();
		if (getClass () == Sincronizacao.class)
			mono.android.TypeManager.Activate ("AvanteSales.Pro.Activities.Sincronizacao, AvanteSales.Pro, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
